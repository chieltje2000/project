...
// Define them as absolute paths to make sure that require_once works as epected

// DIRECTORY_SEPERATOR is a PHP pre-defined constant
// (\ for Windows, / for Unix)
defined('DS') ? null : define('DS', DIRECTORY_SEPARATOR);

defined('SITE_ROOT') ? null : define('SITE_ROOT', 'C:'.DS.'xampp'.DS.'htdocs'.DS.'periode3'.DS.'php'.DS.'PhotoGallery');
